# Bassetlaw — Leafletting Map

A canvassing and leafletting tracker for Bassetlaw. Volunteers can view road-level status, plan routes, and mark progress in real time via a Google Sheets backend.
...
Live: **https://daemeous.github.io/bassetlaw/**
